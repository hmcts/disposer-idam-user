...
public class RestClient {
    ...
    public RestClient(final SecurityUtil securityUtil, final ParameterResolver idamConfig) {
    ...
    private Invocation.Builder createWebTarget(
        ...
        return targetBuilder
           .header("Authorization", securityUtil.getIdamClientToken())
    ...
    private Client buildClient() {
        final ClientConfig clientConfig = new ClientConfig()
            .property(READ_TIMEOUT, idamConfig.getReadTimeout())
            .property(CONNECT_TIMEOUT, idamConfig.getConnectTimeout());
