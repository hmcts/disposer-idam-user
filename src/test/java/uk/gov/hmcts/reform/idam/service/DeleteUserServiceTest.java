...
class DeleteUserServiceTest {
    ...
    void shouldMakeDeleteRequest() {
        ...
        when(idamApiClient.deleteUser(anyString(), anyString())).thenReturn(response);
        ...
        verify(idamApiClient, times(3)).deleteUser(anyString(), pathCaptor.capture());
    ...
    void shouldCatchAndLogExceptionOnIdamApiClientError() {
        ...
        deleteUserService.deleteUsers(staleUserIds);
        verify(idamApiClient, times(1)).deleteUser(HEADER, "userId");
    ...
    void shouldNotMakeDeleteRequest() {
        ...
        List<String> staleUserIds = List.of("a", "b", "c");
        deleteUserService.deleteUsers(staleUserIds);
        verify(idamApiClient, times(0)).deleteUser(anyString(),  anyString());
    }
}
